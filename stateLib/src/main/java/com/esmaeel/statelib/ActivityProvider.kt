...
/**
 * This changes from the registerActivityLifecycleCallbacks to give currentActivity
 * some credibility and to make sure it's a valid value.
 */
var ACTIVITY_TRACKER_REGISTERED: Boolean = false

/**
 *  A Global currentActivity variable to access from anywhere without
 *  the hassle of Injecting a Class in every consumer class.
 *
 ...
 *
 *  get ()     -> checks first for the `ACTIVITY_TRACKER_REGISTERED` is True thus registerActivityTracker has been called in the Application class's onCreate.
            ...
            throw IllegalStateException(
                """
                    ...
                    Caused by: 
                        ...
                        as it won't be accessible until the registerActivityLifecycleCallbacks starts, an activity is being presented -
...
fun Application.registerActivityTracker(
    ...
    registerActivityLifecycleCallbacks(object : Application.ActivityLifecycleCallbacks {
         ...
         *  so overriding the currentvalue is enough. 
         */
